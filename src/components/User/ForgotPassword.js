        ...
        <>
            ...
            <Auth>
                <div className="bg-white border flex flex-col gap-2 p-4 pt-10">
                    <img draggable="false" className="mx-auto h-30 w-36 object-contain" src="https://thumbs.dreamstime.com/z/social-media-icons-d-facebook-instagram-whatsapp-twitter-vector-set-ai-illustrations-social-media-icons-d-facebook-instagram-146604422.jpg" alt="" />
